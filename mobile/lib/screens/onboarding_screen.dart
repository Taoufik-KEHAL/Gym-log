...
/// birth, and height are all on file — see [AppSettings.needsOnboarding].
/// Also reachable later from the Data tab to correct a mistake.
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  bool get _canSave => _dateOfBirth != null && int.tryParse(_heightCtrl.text) != null;
